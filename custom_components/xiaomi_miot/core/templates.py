...
CUSTOM_TEMPLATES = {
    ...
    'lumi_acpartner_miio_status': "{%- set model = results[0] | default('') %}"
                                  ...
                                  "} }}",
    'micloud_statistics_power_cost': "{%- set dat = namespace(today=none,month=0,has_month=false) %}"
                                     "{%- set tim = now() %}"
                                     ...
                                     "'power_cost_month': dat.month | round(3) if dat.has_month else none,"
                                     "} }}",
